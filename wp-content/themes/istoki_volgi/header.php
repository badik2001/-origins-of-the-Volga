<!DOCTYPE html>
<!-- saved from url=(0024)https://istoki-volgi.ru/ -->
<html class="html" xmlns="http://www.w3.org/1999/xhtml" lang="ru">
	<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Совет музеев ПФО.</title>

<?php wp_head(); // сюда подключаются стили и скрипты предподключенные WP
include_once __DIR__."/functions.php"?>

<meta name="keywords" content="музей, проект, ПФО,, выстака, экспозиция, грант, новости музеев, куда сходить, Главная страница">
<meta name="description" content="Истоки - Рождённые на Волге. Совместный проект 56 музеев ПФО.">
...
<link rel="stylesheet" href="./Совет музеев ПФО._files/lytebox.css" type="text/css" media="screen">
<link rel="stylesheet" href="./Совет музеев ПФО._files/flipclock.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/showobj.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/animate.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/owl.carousel.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/owl.theme.default.min.css">

<link rel="stylesheet" type="text/css" href="./Совет музеев ПФО._files/slick.css">
<link rel="stylesheet" type="text/css" href="./Совет музеев ПФО._files/slick-theme.css">

<link rel="stylesheet" href="./Совет музеев ПФО._files/jquery.qtip.min.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/jquery.arcticmodal-0.3.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/simple.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/jquery-ui-1.10.2.custom.min.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/reset.css"> <!-- Resource style -->
<link rel="stylesheet" href="./Совет музеев ПФО._files/style.css"> <!-- Resource style -->
<link rel="stylesheet" type="text/css" href="./Совет музеев ПФО._files/highslide.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/templatestyle.css">

<link rel="stylesheet" href="./Совет музеев ПФО._files/css.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/head.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/foot.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/shop.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/mobile.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/text.css">


<link rel="stylesheet" type="text/css" href="./Совет музеев ПФО._files/style(1).css">
<link rel="stylesheet" type="text/css" href="./Совет музеев ПФО._files/custom.css">
<link rel="stylesheet" type="text/css" href="./Совет музеев ПФО._files/fullpage.css">
<link rel="stylesheet" href="./Совет музеев ПФО._files/style(2).css">
<script async="" src="./Совет музеев ПФО._files/tag.js.Без названия"></script>
<script type="text/javascript" src="./Совет музеев ПФО._files/jquery-latest.min.js.Без названия"></script>
...
<body <?php body_class('site-body');?> >
    ...
    <nav class="nav nav_offsite desktop">
        <ul class="plain clearfix">
            <li class="nav_item_button button"><a href="https://istoki-volgi.ru/kontaktyi" title="Наш адрес"><img src="wp-content\themes\istoki_volgi\img\round-pointer-24px-white.svg" alt="Как проехать">Ульяновск, бульвар Новый Венец, 3/4</a></li>
			<li class="nav_item_button button"><a href="mailto:uokm@mail.ru" title="Отправить нам email"><img src="wp-content\themes\istoki_volgi\img\round-mail-24px.svg" alt="e-mail">uokm@mail.ru</a></li>
            <li class="nav_item_button button"><a href="tel:+7 (8422) 44-30-64" title="Позвонить нам"><img src="wp-content\themes\istoki_volgi/img/round-call-24px-white.svg" alt="Позвонить">+7 (8422) 44-30-64</a></li>
            <li class="nav_item_button button"><a href="https://istoki-volgi.ru/dynamic.php?page=1&amp;setslv=yes" title="Версия оформления"><img src="wp-content\themes\istoki_volgi/img/eye-icon.svg" alt="Версия сайта">Для слабовидящих</a></li>
        </ul>
    </nav>

    <div class="wrapper">
        <nav class="nav nav_onpage">
            <a href="https://istoki-volgi.ru/glavnaya-stranitsa#mobilemenu" class="mobile right"><img src="wp-content\themes\istoki_volgi/img/round-menu-24px.svg" alt="Меню для смартфонов"></a>
            <a href="tel:+7 (8422) 44-30-64" class="mobile right"><img src="wp-content\themes\istoki_volgi/img/round-call-24px.svg" alt="Позвонить"></a>
            <a href="mailto:uokm@mail.ru" class="mobile right"><img src="wp-content/themes/istoki_volgi/img/round-mail-24px.svg" alt="email"></a>
            <a href="https://istoki-volgi.ru/#kontaktyi" class="mobile right"><img src="wp-content\themes\istoki_volgi/img/round-pointer-24px.svg" alt="Наш адрес"></a>
            <a href="https://istoki-volgi.ru/#" class="left logo"><img src="wp-content\themes\istoki_volgi\img\101.png" alt="logo"></a>

            <ul class="plain clearfix menumain desktop mobilemenu">

                <li class="nav_item_text mobile closemobilemenu"><a href="wp-content\themes\istoki_volgi/img/round-close-24px.svg" alt="Закрыть меню для смартфонов"></a></li>
                <li class="nav_item_text active"><a class="active " href="https://istoki-volgi.ru/glavnaya-stranitsa">Главная страница</a></li>
                <li class="nav_item_text"><a class="" href="https://istoki-volgi.ru/novosti" title="Новости">Новости</a></li>
                <li class="nav_item_text"><a class="" href="https://istoki-volgi.ru/proektyi" title="Проекты">Проекты</a></li>
                <li class="nav_item_text"><a class="" href="https://istoki-volgi.ru/muzei-pfo1" title="Музеи ПФО">Музеи ПФО</a></li>
                <li class="nav_item_text"><a class="" href="https://istoki-volgi.ru/ofitsialnoe" title="Официальное">Официальное</a></li>
                <li class="nav_item_text"><a class="" href="https://istoki-volgi.ru/kontaktyi" title="Контакты">Контакты</a></li>
            </ul>
        </nav>
